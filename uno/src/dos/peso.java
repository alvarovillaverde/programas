...
public class peso {
	/*
	 * Crea la clase peso, la cual tendrá las siguientes características: Deberá
	 * tener un atributo donde se almacene el peso de un objeto en kilogramos. En el
	 ...
	 * libras, ‘Li’ para lingotes, ‘Oz para onzas, ‘P’ para peniques, ‘K’ para
	 * kilos, ‘G’ para gramos y ‘Q’ para quintales).
	 * 
	 * Para la realización del ejercicio toma como referencia los siguientes datos:
	 * 1 Libra = 16 onzas = 453 gramos. 1 Lingote = 32,17 libras = 14,59 kg. 1 Onza
	 * = 0,0625 libras = 28,35 gramos. 1 Penique = 0,05 onzas = 1,55 gramos. 1
	 * Quintal =100 libras = 43,3 kg. Crea además un método main para testear y
	 * verificar los métodos de esta clase.
	 */
